...
import { DiagnosticList } from "./Datatable";
...
export default function GraphContainer({
  ...
  if (!diagnosticData) {
    return (
      <div className="p-6">No diagnostic data available for this patient.</div>
    );
  }
  const { respiratory_rate, temperature, heart_rate, blood_pressure_data } =
    diagnosticData;
  return (
    <div className="bg-gray-50 h-screen flex flex-col mr-1">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <BloodPressureChart data={blood_pressure_data} />
            ...
            <div className="grid grid-cols-3 gap-6 ">
              ...
              >
                <DiagnosticCard
                  ...
                  value={`${respiratory_rate} bpm`}
                  description={
                    respiratory_rate > 12 && respiratory_rate < 20
                      ? "Normal"
                      : "Abnormal"
                  }
                  iconUrl={
              ...
              <div style={{ background: "#FFE6E9" }}>
                {" "}
                <DiagnosticCard
                  title="Temprature"
                  value={`${temperature}°F`} // Dynamic data
                  description={temperature === 98.6 ? "Normal" : "Abnormal"}
                  iconUrl={
                    <svg
                      id="temperature"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  } // Use another SVG or icon URL here
                />
              </div>
              <div
                style={{
            ...
            <div className="w-full">
              <DiagnosticList
                diagnosticList={diagnosticData.diagnostic_list || []}
              />
            </div>
          </div>
        </div>
